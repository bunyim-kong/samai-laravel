<?php $__env->startSection('title', 'Edit Country Side - Samai Admin'); ?>
<?php $__env->startSection('page-title', 'Edit Country Side'); ?>
<?php $__env->startSection('page-description', 'Update ' . $countrySide->name); ?>
...
<div class="max-w-4xl">
    <div class="bg-white rounded-2xl border border-[#e4ddd5] shadow-sm p-6 sm:p-8">
        <form
            method="POST"
            action="<?php echo e(route('admin.country-sides.update', $countrySide)); ?>"
        >
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kong-bunyim/Documents/projects/samai-laravel/resources/views/admin/country-sides/edit.blade.php ENDPATH**/ ?>