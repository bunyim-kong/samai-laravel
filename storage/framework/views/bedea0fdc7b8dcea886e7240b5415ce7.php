...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Samai Admin'); ?></title>
        ...
        <div class="min-h-full flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a
                    ...
                    class="flex items-center gap-3 px-4 py-3 rounded-xl transition
                    <?php echo e(request()->routeIs('admin.country-sides.*')
                        ? 'bg-[#b7936e] text-[#2d241c]'
                        : 'text-gray-200 hover:bg-white/10'); ?>"
                >
                ...
                <a
                    ...
                    class="flex items-center gap-3 px-4 py-3 rounded-xl transition
                    <?php echo e(request()->routeIs('admin.areas.*')
                        ? 'bg-[#b7936e] text-[#2d241c]'
                        : 'text-gray-200 hover:bg-white/10'); ?>"
                >
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-gray-500">
                            <?php echo $__env->yieldContent('page-description', 'Manage your Samai Rum Map'); ?>
                        </p>
                    </div>
...
</html><?php /**PATH /home/kong-bunyim/Documents/projects/samai-laravel/resources/views/layouts/admin.blade.php ENDPATH**/ ?>