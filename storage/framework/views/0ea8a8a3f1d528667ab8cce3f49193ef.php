...
<head>
    ...
    <title><?php echo e($countrySide->name); ?> Map</title>
...
<script>
    const mapData = {
        center: <?php echo json_encode($mapCenter, 15, 512) ?>,
        zoom: <?php echo json_encode($mapZoom, 15, 512) ?>,
        markers: <?php echo json_encode($markers, 15, 512) ?>
    };
...
</html><?php /**PATH /home/kong-bunyim/Documents/projects/samai-laravel/resources/views/interactive-map.blade.php ENDPATH**/ ?>